...
<body>
    <div class="w-full">
        ...
        <div class="w-full image-slider">
            <div>
                <img src="public/images/banner.png" alt="" class="w-full h-[600px] object-cover">
            </div>
            <div>
                <img src="public/images/banner2.png" alt="" class="w-full h-[600px] object-cover">
            </div>
        </div>
        <div class="section-body px-20 mt-20">
            <h1 class="uppercase text-center font-semibold text-[34px] tracking-wider">New arrivals</h1>
            <div class="list-product flex flex-wrap gap-y-8 mt-8 ml-[-24px]">
                <div class="border border-gray-200 flex flex-col justify-center items-center pt-1 pb-3 w-[calc(25%-24px)] ml-6">
                    <div class="border-b border-gray-00">
                        <a class="" href="{{url('product/1')}}">
                            <img src="public/images/t-shirt.png" class="w-full h-full object-cover px-3" alt="">
                        </a>
                    </div>
                    <div class="mt-2">
            ...
            <div class="mt-10 flex justify-center">
                <button class="px-6 py-2 border border-black hover:bg-gray-200">See more</button>
            </div>

            <div class="mt-20">
                <h1 class="uppercase text-center font-semibold text-[34px] tracking-wider">Best sellers</h1>
                <div class="sale-slider flex gap-x-10 mt-8">
                    <div
            ...
            {{-- Frame top, seller --}}
            <div class="mt-20 flex gap-x-5">
                <div class="w-[50%] relative top-frame">
                    <a href="">
                        <img src="public/images/sale3.png" alt="" class="w-full h-[650px] object-cover">
                        <p class="absolute left-[50%] top-[50%] text-[50px] font-bold text-white title-top">Tops</p>
                    </a>
                </div>
                <div class="w-[50%] relative sale-frame">
                    <a href="">
                        <img src="public/images/sale4.png" alt="" class="w-full h-[650px] object-cover">
                        <p class="absolute left-[40%] top-[50%] text-[50px] font-bold text-white title-top title-sale">
                            Best Sellers
                        </p>
            ...
            <div class="mt-20">
                <h1 class="uppercase text-center font-semibold text-[34px] tracking-wider">our brand identity</h1>
                <div class="flex mt-6">
                    <img src="public/images/branch1.png" alt="" class="w-[25%] object-cover h-[300px]">
                    <img src="public/images/branch2.png" alt="" class="w-[25%] object-cover h-[300px]">
                    <img src="public/images/branch3.png" alt="" class="w-[25%] object-cover h-[300px]">
                    <img src="public/images/branch4.png" alt="" class="w-[25%] object-cover h-[300px]">
                </div>
            </div>
        </div>
        {{-- footer --}}
