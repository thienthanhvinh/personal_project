...
<body>
    <div class="w-full">
        {{-- <div class="flex items-center justify-between px-20 bg-[#F1F1F1]">
            ...
            <div>
                <ul class="uppercase flex font-semibold gap-x-10 text-lg" id="main-menu">
                    ...
                    <li class="py-2"><a href="#">sale</a></li>
        ...
        <div class="section-body px-20 mt-20">
            <div class="mt-10 flex flex-wrap ml-[-32px] gap-y-72">
                <div class="w-[calc(33.33333%-32px)] ml-8">
                    <a href="">
                        <img src="../public/images/post1.png" alt="" class="w-full h-full object-cover">
                    </a>
                    <div class="mt-4 flex justify-center gap-x-5 items-center">
                        <p
                            class="px-1 py-2 border border-gray-700 inline-block rounded-2xl hover:underline hover:font-semibold">
                            Promotion information</p>
                        <a href=""
                            class="px-2 py-2 border border-gray-700 rounded-2xl hover:underline hover:font-semibold">See
                            more</a>
                        <p class="px-1 py-2 border border-gray-700 inline-block rounded-2xl hover:font-semibold">
                            14/06/2023</p>
                    </div>
                    <div>
                        <a href="" class="inline-block mt-4 font-semibold text-xl">
                            DirtyCoins 326 Quang Trung chính thức mở cửa
                        </a>
                        <p class="font-light text-justify">Cửa hàng thứ 9 của DirtyCoins chuẩn bị mở cửa tại 326 Quang
                            Trung, Phường 10, quận Gò Vấp. Vẫn tiếp nối thiết kế mang phong cách hype room của cửa hàng
                            flagship của t...</p>
                    </div>
                </div>
                <div class="w-[calc(33.33333%-32px)] ml-8">
